      ...
      homeConfigurations = {
        "com-mac" = home-manager.lib.homeManagerConfiguration {
          ...
          modules = [
            ...
            ./users/nixsys/nixsystem.nix
          ];
        };
        "fnixos07xx-linux" = home-manager.lib.homeManagerConfiguration {
          pkgs = nixpkgs.legacyPackages.x86_64-linux;
          extraSpecialArgs = { inherit inputs; };
          modules = [
            ./users/fnixos-linux/fnixos07xx-linux.nix
          ];
        };
        "fnixos-vm" = home-manager.lib.homeManagerConfiguration
          {
            pkgs = nixpkgs.legacyPackages.aarch64-linux;
            extraSpecialArgs = { inherit inputs; };
            modules = [
              ./users/fnixos-vm/fnixos-vm.nix
            ];
          };
